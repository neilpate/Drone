...
**Next:** the control law — a PID that turns the attitude estimate and pilot command into the mixer's roll/pitch/yaw demand, closing the loop for self-levelling (angle-mode) flight.
