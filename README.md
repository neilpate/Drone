...
The ground station plots and logs every signal live — pilot command, six-axis IMU, attitude estimate, controller demand and the four mixed motor outputs — and times the round trip:

![Ground station: live telemetry plot and table showing pilot command, IMU, attitude estimate, controller demand and the four motor outputs, with the Stabilized/Manual control-mode toggle; attitude reads near zero with the accelerometer calibration applied.](doc/images/groundstation%204.png)
