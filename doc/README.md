...
Vision and architecture agreed. Eight ADRs in place ([decisions/](decisions/README.md)). No code yet — next step is Phase 1 bring-up once hardware (ICM-42688 breakout, motor + ESC + bench PSU) arrives. See [`00-vision.md`](00-vision.md) for the phase plan.
